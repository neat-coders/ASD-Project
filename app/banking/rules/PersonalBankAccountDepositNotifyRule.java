...
public class PersonalBankAccountDepositNotifyRule extends Subject implements BankTransactionRule {

    public PersonalBankAccountDepositNotifyRule(List<Observer> observerList) {
